...
def parse_args():
    ...
    parser.add_argument("--checkpoints", type=str, default='v8', required=False)
    ...
    parser.add_argument("--use_extra", type=int, default=1, required=False)
    parser.add_argument("--enhance_mode", type=int, default=1, required=False)
...
def train(fold, model, loss_func, optimizer, checkpoints, epochs, lr_scheduler=None, enhance_mode=1):
    print('Train......................')
    # 记录每个epoch的loss和acc
    record = []
    best_acc = 0
...
if __name__ == '__main__':
    ...
    if Height == 400:
        ...
        train_mean, train_std = [0.8408691800077757, 0.843093117582798, 0.8397223384737968], [0.20037801617731651, 0.19797363897711037, 0.20214536744058131]
    else:
    ...
    train_paths, val_paths = split_data(args.fold, use_extra=use_extra)
    # 加载训练数据集，转化成标准格式
    ...
    train(args.fold, model, loss_func, optimizer, checkpoints, epochs, scheduler, enhance_mode)
